      ...
      <div class="col-12">
        ...
        <div class="card-product__shop">
          <div class="card-product__price">
            <div class="card-product__price_old">
              39 900 ₽
            </div>
            <div class="card-product__price_new">
              29 900 ₽
            </div>
          </div>

          <div class="card-product__icon">
            <div class="card-product__icon_cart">
              <ui-icon-action 
                type='cart'         
              />
              <!-- type = 'cart' - установлен в UiIconAction props по умолчанию, если будет изменён, тут лучше отдельно прописать? -->

            </div>
            <div class="card-product__icon_favorite">
              <ui-icon-action 
                type='favorite'
              />
            </div>
        ...
        <div class="card-product__buy">
          ...
          <!-- style верно ли? 
            - т.к. !important не срабатывает;
            - в классе через ',' не удалось написать в класс class="full-width" , созданный font-size в generel.scss;
            - в div также не работает;           
          -->
        </div>
...
import UiButton from './Ui/UiButton.vue'
  ...
  export default {
    ...
    props: {
      titleCard: {
        type: String,
        default: 'Kugoo Kirin M4'
        // default: 'name' - дынные тянуться из api?        
      }
    }
  }
</script>
...
.card-product {
  ...
  &__price {
    display: flex;      //прописал эти св-ва в price, чтоб цена была в центре, если скидки не будет
  ...
  &__buy { 
    ...
    justify-content: center;    
    padding: 0 24px;
    // font-size: 12px !important;   // так не работает!
